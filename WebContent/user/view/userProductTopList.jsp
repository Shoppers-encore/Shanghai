...
<html>
	...
	<body>
		...
		<div class="jumbotron col-12 bg-white text-center productCategoryJumbotron mb-0 h-100">
			<h5>${str_cat_TnTOP}</h5>		
			<small><a class="col-3 text-secondary" href="userProductTopList.jk">${str_cat_TnTOP_ALL}</a></small>
			<small><a class="col-3 text-secondary" href="userProductTopList.jk?category=TSHIRTS">${str_cat_TSHIRTS}</a></small>
			<small><a class="col-3 text-secondary" href="userProductTopList.jk?category=KNIT">${str_cat_KNIT}</a></small>
		</div>
