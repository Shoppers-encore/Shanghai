...
<html>
	...
	<body class="container">
		...
		<%@ include file="../form/userHeader.jsp" %>
			<br>
			<a href="userProductOuterList.jk">${str_cat_OUTER_ALL}</a> &nbsp;/&nbsp;
			<a href="userProductOuterList.jk?category=JKnJP">${str_cat_JKnJP}</a>&nbsp;/&nbsp;
			<a href="userProductOuterList.jk?category=COAT">${str_cat_COAT}</a>&nbsp;/&nbsp;
					...
					<div align="center">
					    <c:if test="${productCount gt 0}">
							...
							<c:forEach var="i" begin="${startPage}" end="${endPage}">
								...
								<a href="userProductOuterList.jk?category=${category}&pageNum=${i}">[${i}]</a>
								</c:if>
							</c:forEach>
